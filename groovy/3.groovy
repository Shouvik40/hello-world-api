        ...
        stage('Deploy Docker Image to EC2') {
            steps {
                script {
                    ...
                    // Copy the uniquely tagged Docker image to the EC2 instance and run the container
                    sh """
                    scp -i ${SSH_KEY_PATH} /var/lib/jenkins/workspace/hello-world-pipeline/${DOCKER_IMAGE}_${BUILD_NUMBER}.tar ${EC2_USER}@${ec2_ip}:/home/${EC2_USER}/
